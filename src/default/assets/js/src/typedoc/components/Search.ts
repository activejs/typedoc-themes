...
namespace typedoc.search {
    ...
    export class Search extends Component {
        ...
        constructor(options: IComponentOptions) {
            ...
            this.searchCmp = document.querySelector('#tsd-search') as HTMLElement;
        ...
        private updateResults() {
            ...
            for (var i = 0, c = Math.min(40, res.length); i < c; i++) {
                ...
                item.innerHTML = `<a href="${this.base + row.url}" class="tsd-kind-icon">${name}</a>`;
        ...
        private bindEvents() {
            ...
            this.searchCmp.addEventListener('click', (event) => {
